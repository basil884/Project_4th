...
class _EducationalGamesViewState extends State<EducationalGamesView> {
  ...
  final List<Map<String, dynamic>> _gameIcons = [
    {'icon': Icons.psychology_outlined, 'color': const Color(0xFFD946EF)}, // Brain
    {'icon': Icons.vaccines_outlined, 'color': const Color(0xFF64748B)},  // Syringe
    {'icon': Icons.favorite_border, 'color': const Color(0xFFEF4444)},   // Heart
    {'icon': Icons.medication_liquid_outlined, 'color': const Color(0xFFF59E0B)}, // Medicine
    {'icon': Icons.medical_services_outlined, 'color': const Color(0xFF10B981)}, // First Aid
  ...
  final List<Map<String, dynamic>> _triviaQuestions = [
    ...
    },
    {
      ...
      'options': ['Under 100 mg/dL', '140-199 mg/dL', 'Over 200 mg/dL', '70-130 mg/dL'],
      'answer': 0,
    },
    {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tabs
            _buildTabItem("Memory Match", Icons.settings_suggest, const Color(0xFF2563EB)),
            const SizedBox(height: 15),
            _buildTabItem("Health Trivia", Icons.quiz_outlined, const Color(0xFF10B981)),
            const SizedBox(height: 15),
            _buildTabItem("Relaxation", Icons.self_improvement, const Color(0xFFA855F7)),
            const SizedBox(height: 30),
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(color: isSelected ? Colors.white24 : color.withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: isSelected ? Colors.white : Colors.black87)),
                  Text(
                    title == 'Memory Match' ? 'Boost cognitive skills & focus' : (title == 'Health Trivia' ? 'Test your knowledge' : 'Reduce anxiety'),
                    style: TextStyle(fontSize: 12, color: isSelected ? Colors.white70 : Colors.black54),
                  ),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios, color: isSelected ? Colors.white : Colors.grey, size: 14),
          ],
        ),
      ),
    );
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: const [
                  Icon(Icons.grid_view_rounded, color: Color(0xFF2563EB), size: 22),
                  SizedBox(width: 10),
                  Text("Active Game", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                ],
              ),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                decoration: BoxDecoration(color: const Color(0xFFEFF6FF), borderRadius: BorderRadius.circular(15)),
                child: Text("Moves: $_moves", style: const TextStyle(color: Color(0xFF2563EB), fontWeight: FontWeight.bold, fontSize: 12)),
              ),
            ],
          ),
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: _flipped[index] || _matched[index] ? Colors.white : const Color(0xFF2563EB),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(color: const Color(0xFF2563EB), width: 2),
                    ),
                    alignment: Alignment.center,
                    child: _flipped[index] || _matched[index] 
                      ? Icon(_items[index]['icon'], color: _items[index]['color'], size: 30)
              ...
              children: [
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      alignment: Alignment.center,
                      child: Icon(_items[index]['icon'], color: _items[index]['color'], size: 30),
                    );
                  },
                ),
                const SizedBox(height: 30),
                Row(
                  ...
                  children: const [
                    ...
                    SizedBox(width: 8),
                    Text("Great job! Brain exercise complete.", style: TextStyle(color: Color(0xFF10B981), fontWeight: FontWeight.bold, fontSize: 14)),
                  ],
                ),
                const SizedBox(height: 25),
                SizedBox(
          ...
          children: [
            Row(
              children: const [
                ...
                SizedBox(width: 10),
                Text("HEALTH TRIVIA", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF1E293B))),
              ],
            ),
            const SizedBox(height: 40),
            Container(
              ...
              child: const Icon(Icons.emoji_events_outlined, color: Color(0xFF10B981), size: 45),
            ),
            const SizedBox(height: 30),
            Text(
            ...
            const SizedBox(height: 10),
            const Text("Thanks for learning!", style: TextStyle(color: Colors.black54, fontSize: 16)),
            const SizedBox(height: 40),
            SizedBox(
              width: double.infinity,
              height: 55,
              child: ElevatedButton(
                ...
                child: const Text("Restart Quiz", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ),
            ),
          ],
        ),
        ...
        children: [
          Row(
            children: const [
              ...
              SizedBox(width: 10),
              Text("Health Trivia", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
            ],
          ),
          const SizedBox(height: 25),
          Text(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 15, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal, color: const Color(0xFF1E293B)),
                        ),
                      ),
          ...
          SizedBox(
            ...
            height: 55,
            child: ElevatedButton(
              onPressed: _selectedTriviaOption == null ? null : () {
              ...
              child: Text(
                _currentQuestionIndex == _triviaQuestions.length - 1 ? "Finish Quiz" : "Submit Answer", 
