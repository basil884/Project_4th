...
class MedicalDisclaimerView extends StatelessWidget {
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.assignment_late_outlined, color: Color(0xFFEF4444), size: 30),
                        ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: const [
                                Text("SugarWise", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                                Text("Smart Diabetes Management", style: TextStyle(color: Colors.white70, fontSize: 11)),
                              ],
                            ),
                          ],
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text("I Understand & Return Home", style: TextStyle(fontWeight: FontWeight.bold)),
                          ),
                        ),
                      ],
                    ),
  ...
  Widget _buildDisclaimerItem(String title, String desc, IconData icon, Color iconColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
