...
class _FAQsViewState extends State<FAQsView> {
  ...
  final List<String> _categories = ['All', 'General', 'Patients', 'Doctors', 'Tech'];
        ...
        child: Column(
          children: [
                  ...
                  Container(
                    ...
                    child: const TextField(
                      decoration: InputDecoration(
                        ...
                        hintText: "Search for keywords (e.g., booking, password)...",
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ..._faqs.where((f) => _activeCategory == 'All' || f['category'] == _activeCategory).map((faq) {
                    return Container(
                      ...
                      child: Theme(
                        ...
                        child: ExpansionTile(
                          leading: Container(
                            ...
                            child: const Text("Q", style: TextStyle(color: Color(0xFF64748B), fontWeight: FontWeight.bold)),
                          ),
                          title: Text(faq['question'], style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF1E293B))),
                          children: const [
                            Padding(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.headset_mic_outlined, color: Color(0xFF2563EB), size: 30),
                        ),
                        const SizedBox(height: 20),
                        const Text("Still have questions?", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                        const SizedBox(height: 10),
                        const Text(
