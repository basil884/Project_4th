          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      gradient: LinearGradient(colors: [Color(0xFF818CF8), Color(0xFFC084FC)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                    ),
                    child: const Icon(Icons.favorite, color: Colors.white, size: 35),
                  ),
                  const SizedBox(height: 20),
                  const Text("Our Vision", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black)),
                  const SizedBox(height: 10),
                  const Text(
                  ...
                  const SizedBox(height: 20),
                  _buildCheckItem("Make diabetes management simple and accessible"),
                  _buildCheckItem("Reduce diabetes-related emergencies in children"),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Core Values", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
                  const SizedBox(height: 20),
                  _buildValueRow(Icons.accessibility_new, "Child-Centered", "Everything we do puts children first"),
                  const SizedBox(height: 20),
                  _buildValueRow(Icons.shield_outlined, "Safety First", "Highest standards of data privacy and medical safety"),
                ],
              ),
            ),
            const SizedBox(height: 20),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Impact Goals 2026", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
                  const SizedBox(height: 20),
                  Row(
                    children: [
                      _buildImpactCard("50K+", "Children Helped", const Color(0xFF3B82F6)),
                      const SizedBox(width: 15),
                      _buildImpactCard("90%", "Reduced Emergencies", const Color(0xFF10B981)),
                    ],
                  ),
                ],
              ),
            ...
            TextButton.icon(
              onPressed: () => Navigator.pop(context),
              icon: const Icon(Icons.arrow_back, size: 20, color: Color(0xFF3B82F6)),
              label: const Text("Back to About US", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF3B82F6))),
            ),
            const SizedBox(height: 40),
          ],
        ),
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(color: const Color(0xFFDBEAFE), borderRadius: BorderRadius.circular(15)),
