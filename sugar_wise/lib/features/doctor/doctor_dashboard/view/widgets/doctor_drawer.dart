...
class CustomDoctorDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final doctorProfileVM = Provider.of<DoctorProfileViewModel>(context, listen: false);
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const DoctorProfileView()),
                    );
                  },
                ),
                _buildDrawerItem(
                ...
                _buildDrawerItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const InsulCalculatorPatient()),
                    );
                  },
                ),
                _buildDrawerItem(
                ...
                _buildExpandableSection(context, Icons.mail_outline, "Contact Us", ["Email", "Support"]),
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const SettingsScreenDoctor()),
                    );
                  },
                ),
                _buildDrawerItem(
  ...
  Widget _buildDrawerItem(
    ...
    return Container(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: isLogout ? Colors.redAccent : (isSelected ? primaryBlue : Colors.blueAccent.withOpacity(0.7)),
          size: 24,
        ),
        title: Text(
          title,
        ...
        trailing: hasArrow ? const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey) : null,
        onTap: onTap,
      ),
    );
  }

  Widget _buildExpandableSection(BuildContext context, IconData icon, String title, List<String> children) {
    return Container(
      margin: const EdgeInsets.only(right: 20),
      child: Theme(
        data: ThemeData().copyWith(dividerColor: Colors.transparent),
        child: ExpansionTile(
          leading: Icon(icon, color: Colors.blueAccent.withOpacity(0.7), size: 24),
          title: Text(
            title,
            style: TextStyle(
            ...
            return ListTile(
              ...
              onTap: () {
                if (childText == "About Us") {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const MonitoringDashboardView()),
                  );
                } else if (childText == "Educational Games") {
                  Navigator.pop(context);
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const EducationalGamesView()),
                  );
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const DataProtectionView()),
                  );
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const MedicalDisclaimerView()),
                  );
