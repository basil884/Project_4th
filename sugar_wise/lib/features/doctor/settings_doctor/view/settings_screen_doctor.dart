...
class SettingsScreenDoctor extends StatelessWidget {
            ...
            children: [
              ...
              _CustomSettingsItem(
                ...
                onTap: () => viewModel.selectItem(2, () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SecuritySettingDoctor()),
                  );
                }),
              ),
  ...
  Widget _buildLogoutButton(BuildContext context, SettingsViewModel viewModel, bool isDark) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: isDark ? Border.all(color: Colors.red.withOpacity(0.3)) : null,
        ),
        child: Row(
...
class _CustomSettingsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? const Color(0xff2F66D0) : Theme.of(context).cardColor,
        borderRadius: BorderRadius.circular(16),
        border: isDark && !isSelected ? Border.all(color: Colors.grey.shade800) : null,
        boxShadow: [
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? Colors.white.withOpacity(0.2) : iconBgColor,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontWeight: FontWeight.bold,
          color: isDark ? Colors.grey.shade400 : Colors.black.withOpacity(0.8),
          fontSize: 12,
          letterSpacing: 0.5,
        ),
      ),
