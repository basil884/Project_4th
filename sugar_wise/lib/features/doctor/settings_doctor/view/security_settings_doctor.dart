...
class SecuritySettingDoctor extends StatelessWidget {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            ...
            style: TextStyle(fontSize: 14, color: isDark ? Colors.grey.shade300 : Colors.black87, height: 1.5),
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: Text("Cancel", style: TextStyle(color: isDark ? Colors.grey.shade400 : Colors.grey, fontWeight: FontWeight.bold)),
            ),
            ElevatedButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Security Settings", style: TextStyle(color: textColor, fontWeight: FontWeight.w600)),
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        elevation: 0,
        leading: IconButton(
                ...
                child: ListTile(
                  onTap: () {
                    if (index == 0) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ChangePassDoctor()),
                      );
                    } else {
                  ...
                  title: Text(item['title'] as String, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: textColor)),
                  subtitle: Text(item['subtitle'] as String, style: TextStyle(fontSize: 13, color: isDark ? Colors.grey.shade400 : Colors.grey.shade600)),
